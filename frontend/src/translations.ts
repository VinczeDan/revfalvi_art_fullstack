...
Ez volt a csúcsok csúcsa!!!! Ez idő alatt tanultam a londoni székhelyű Westminster Egyetemen. Alább láthatjátok azt a mester foknak megfelelő diplomát, amit az egyetem állított ki.`,
    ...
    videos: {
      title: "Videók",
      description: "Tekintse meg legújabb oktatóvideóimat és bemutatóimat.",
    },
    news: {
      title: "Friss hírek",
      description:
    ...
    contact: {
      ...
      taxNumber: "91713838-1-42",
      regNumber: "61764965",
      location: "1141 Budapest, Mogyoródi út 100 II.em. 6.",
    },
  },
  en: {
    navigation: {
...
During this period, I also studied at University of Westminster. Below, you can see the diploma issued by the university, which is equivalent to a master’s degree.`,
    ...
    videos: {
      title: "Videos",
      description: "Check out my latest educational videos and demonstrations.",
    },
    news: {
      title: "Latest News",
      description:
